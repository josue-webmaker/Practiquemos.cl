  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.menuList} contentContainerStyle={[styles.menuListContent, { paddingBottom: (Platform.OS === 'web' ? 34 : insets.bottom) + 20 }]}>
        ...
        />
        <MenuItem
          icon={<View style={[styles.menuIcon, { backgroundColor: '#fce7f3' }]}><Text style={styles.menuEmoji}>🧠</Text></View>}
        ...
        />
        <MenuItem
          icon={<View style={[styles.menuIcon, { backgroundColor: '#ede9fe' }]}><Text style={styles.menuEmoji}>💎</Text></View>}
          title="Packs Premium"
          description="Acceso ilimitado a todos los exámenes, explicaciones detalladas y estadísticas avanzadas."
          onPress={() => router.push('/plans')}
        />
        <MenuItem
          icon={<View style={[styles.menuIcon, { backgroundColor: '#dbeafe' }]}><Text style={styles.menuEmoji}>📊</Text></View>}
        ...
        {isAdmin && (
          <MenuItem
            icon={<View style={[styles.menuIcon, { backgroundColor: '#fecaca' }]}><Text style={styles.menuEmoji}>⚙️</Text></View>}
...
const styles = StyleSheet.create({
  ...
  menuItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, marginHorizontal: 14, marginVertical: 7, paddingVertical: 18, paddingHorizontal: 16, borderRadius: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 4, elevation: 2 },
  ...
  menuContent: { flex: 1, marginRight: 6, minWidth: 0 },
  menuTitleRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap' as const, gap: 6, marginBottom: 4 },
  menuTitle: { fontSize: 15.5, fontFamily: 'Nunito_700Bold', color: Colors.text, flexShrink: 1 },
  menuDescription: { fontSize: 13, fontFamily: 'Nunito_400Regular', color: Colors.textSecondary, lineHeight: 18 },
  badge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10, alignSelf: 'flex-start' as const },
