    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.body}>
          Practiquemos.cl recopila la siguiente información personal cuando
          creas una cuenta:{"\n"}• Nombre completo{"\n"}• Correo electrónico
          {"\n"}• Nombre de usuario{"\n"}• Tipo de licencia seleccionada{"\n"}•
          Progreso en exámenes y resultados de práctica{"\n"}• Preguntas
          guardadas como favoritas
        </Text>

        <Text style={styles.heading}>2. Cómo usamos tus datos</Text>
        <Text style={styles.body}>
          Utilizamos tu información para:{"\n"}• Personalizar tu experiencia de
          aprendizaje{"\n"}• Guardar tu progreso y estadísticas{"\n"}• Gestionar
          tu cuenta y plan de suscripción{"\n"}• Mejorar nuestros servicios y
        ...
        <Text style={styles.body}>
          ...
          financieros directamente; los pagos son procesados por plataformas de
          pago seguras de terceros.
        </Text>
        ...
        <Text style={styles.body}>
          ...
          perfil. Al eliminar tu cuenta, se borrarán permanentemente todos tus
          datos, incluyendo resultados de exámenes, favoritos y progreso por
        ...
        <Text style={styles.body}>
          Al crear una cuenta y utilizar Practiquemos.cl, aceptas estos términos
          de servicio y nuestra política de privacidad. Si no estás de acuerdo,
        ...
        <Text style={styles.body}>
          ...
          debes compartir tu cuenta con otras personas{"\n"}• Nos reservamos el
        ...
        <Text style={styles.body}>
          ...
          {"\n"}• Los planes Premium otorgan acceso completo por un período
          determinado (10 o 30 días){"\n"}• Los pagos en iOS se procesan a
          través de la App Store de Apple{"\n"}• Los pagos en Android y web se
          procesan a través de Mercado Pago{"\n"}• Los precios están sujetos a
          cambios con previo aviso{"\n"}• Los planes Premium no son
          suscripciones con renovación automática; se adquieren como compras
          únicas por un período determinado
        </Text>

        <Text style={styles.heading}>5. Gestión de compras y reembolsos</Text>
        <Text style={styles.body}>
          Para usuarios de iOS:{"\n"}• Las compras se procesan a través de tu
          cuenta de Apple y están sujetas a los términos de Apple{"\n"}• Para
          gestionar tus compras, ve a Ajustes {">"} tu nombre {">"}{" "}
          Suscripciones en tu dispositivo iOS{"\n"}• Puedes restaurar compras
          previas desde la pantalla de Packs Premium dentro de la aplicación
          {"\n"}• Los reembolsos deben solicitarse directamente a Apple a través
          de reportaproblem.apple.com{"\n"}
          {"\n"}
          Para usuarios de Android y Web:{"\n"}• Las compras se procesan a
          través de Mercado Pago{"\n"}• Para consultas sobre pagos o reembolsos,
          contáctanos en practiquemos.cl@gmail.com
        </Text>

        <Text style={styles.heading}>6. Contenido educativo</Text>
        <Text style={styles.body}>
          El contenido de Practiquemos.cl es de carácter educativo y
          complementario. No garantizamos la aprobación del examen oficial. Las
          preguntas se basan en el material oficial pero pueden diferir del
          examen real.
        </Text>
        ...
        <Text style={styles.body}>
          Practiquemos.cl se ofrece "tal cual". No nos hacemos responsables por
          interrupciones del servicio, pérdida de datos o resultados en el
          examen oficial.
        </Text>

        <Text style={styles.heading}>9. Contacto</Text>
        <Text style={styles.body}>
          Para consultas sobre estos términos o la política de privacidad,
          contáctanos en practiquemos.cl@gmail.com
        </Text>
